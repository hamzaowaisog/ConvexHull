...
public class BruteForceLineIntersection extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Brute Force Line Intersection");
    ...
    private void run(ActionEvent actionEvent) throws InterruptedException {
        ...
        if (doIntersect(p1, p2, p3, p4)) {
            Platform.runLater(() -> {
                ...
                alert.setTitle("Brute Force Line Intersection");
    ...
    public boolean doIntersect (points p1,points p2,points p3,points p4) throws InterruptedException {
    ...
    private int orientation(points p, points q, points r) throws InterruptedException {
        double val = (q.getX() - p.getX()) * (r.getY() - p.getY())- (q.getY() - p.getY()) * (r.getX() - p.getX()) ;
    ...
    private void displayOrientationResult(points p , points q , points r) throws InterruptedException {
        ...
        double orientation = (q.getY() - p.getY()) * (r.getX() - q.getX()) -
        ...
        Label label = new Label(orientation > 0 ? "ACW" : "CW");
